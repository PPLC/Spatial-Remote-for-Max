...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 608.0, 244.0, 137.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 895.9488525390625, 85.0, 100.0, 22.0 ],
					"text" : "OSC-route"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 895.9488525390625, 40.5, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 58.5, 17.5, 24.0, 24.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 162.0, 419.0, 29.0, 22.0 ],
									"text" : "thru"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 199.00885009765625, 315.0, 57.0, 22.0 ],
									"text" : "/xy $1 $2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 236.0, 256.0, 29.5, 22.0 ],
									"text" : "pak"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 258.00885009765625, 208.0, 33.0, 22.0 ],
									"text" : "* 10."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 199.00885009765625, 208.0, 33.0, 22.0 ],
									"text" : "* 10."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 199.00885009765625, 125.2403564453125, 137.0, 22.0 ],
									"text" : "route /1/fader1 /1/fader2"
								}
...
,
					"patching_rect" : [ 51.0, 105.0, 133.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 275.5, 328.5, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 263.5, 190.5, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 124.5, 220.0, 5.0, 100.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "int" ],
					"patching_rect" : [ 109.5, 220.0, 5.0, 100.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "int" ],
					"patching_rect" : [ 73.5, 220.0, 5.0, 100.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "int" ],
					"patching_rect" : [ 58.5, 220.0, 5.0, 100.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 58.5, 65.5, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 174.5, 481.0, 565.5, 481.0 ],
					"order" : 0,
					"source" : [ "obj-36", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 136.5, 481.0, 481.5, 481.0 ],
					"order" : 0,
					"source" : [ "obj-36", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 98.5, 481.0, 397.5, 481.0 ],
					"order" : 0,
					"source" : [ "obj-36", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-48", 0 ],
					"midpoints" : [ 60.5, 481.0, 313.5, 481.0 ],
					"order" : 0,
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 174.5, 158.25, 273.0, 158.25 ],
					"order" : 1,
					"source" : [ "obj-36", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 136.5, 158.25, 273.0, 158.25 ],
					"order" : 1,
					"source" : [ "obj-36", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 98.5, 158.25, 273.0, 158.25 ],
					"order" : 1,
					"source" : [ "obj-36", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 60.5, 158.25, 273.0, 158.25 ],
					"order" : 1,
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 60.5, 173.0, 61.0, 173.0 ],
					"order" : 2,
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 98.5, 173.0, 76.0, 173.0 ],
					"order" : 2,
					"source" : [ "obj-36", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 174.5, 173.0, 127.0, 173.0 ],
					"order" : 2,
					"source" : [ "obj-36", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 136.5, 173.0, 112.0, 173.0 ],
					"order" : 2,
					"source" : [ "obj-36", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 273.0, 702.25, 926.25274658203125, 702.25 ],
					"order" : 0,
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 273.0, 702.25, 910.549042878327555, 702.25 ],
					"order" : 1,
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 273.0, 702.25, 894.845339174623859, 702.25 ],
					"order" : 2,
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 273.0, 702.25, 879.141635470920164, 702.25 ],
					"order" : 3,
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-3::obj-1::obj-94" : [ "live.toggle", "live.toggle", 0 ],
			"obj-3::obj-1::obj-118" : [ "live.toggle[3]", "live.toggle", 0 ],
			"obj-3::obj-1::obj-113" : [ "live.toggle[4]", "live.toggle", 0 ],
			"obj-29::obj-55" : [ "live.text[3]", "live.text", 0 ],
			"obj-3::obj-1::obj-132::obj-3" : [ "live.tab", "live.tab", 0 ],
			"obj-29::obj-607" : [ "live.button[1]", "live.button", 0 ],
			"obj-29::obj-606" : [ "live.text[2]", "live.text", 0 ],
			"obj-29::obj-16" : [ "live.text[1]", "live.text", 0 ],
			"obj-3::obj-1::obj-132::obj-7" : [ "live.numbox", "live.numbox", 0 ],
			"obj-3::obj-1::obj-132::obj-10" : [ "live.numbox[2]", "live.numbox", 0 ],
			"obj-3::obj-1::obj-98" : [ "live.toggle[1]", "live.toggle", 0 ],
			"obj-29::obj-11" : [ "live.text[4]", "live.text", 0 ],
			"obj-3::obj-1::obj-103" : [ "live.toggle[2]", "live.toggle", 0 ],
			"obj-27" : [ "live.gain~[3]", "loudspeakers", 0 ],
			"obj-3::obj-1::obj-132::obj-19" : [ "live.numbox[3]", "live.numbox", 0 ],
			"obj-3::obj-1::obj-108" : [ "live.toggle[5]", "live.toggle", 0 ],
			"obj-3::obj-1::obj-132::obj-15" : [ "live.numbox[1]", "live.numbox", 0 ],
			"parameterbanks" : 			{
...
, 			{
				...
				"bootpath" : "~/Documents/Max 8/Library/spat5/help",
				"patcherrelativepath" : "../../../../../Documents/Max 8/Library/spat5/help",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "spat5.helpdetails.js",
				"bootpath" : "~/Documents/Max 8/Library/spat5/javascript",
				"patcherrelativepath" : "../../../../../Documents/Max 8/Library/spat5/javascript",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
